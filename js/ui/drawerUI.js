...
(function () {
  ...
  function activateTab(tabName) {
    ...
    // 切到总结 tab 时清除红点（视为已查看）
    if (tabName === 'summary') {
      const badge = document.getElementById('summary-btn-badge');
  ...
  function initDrawers() {
    ...
    // 游戏模式：打开统一的"信息"抽屉（内部 tab 由 localStorage 记忆，已在 initSidebarTabs 中恢复）
