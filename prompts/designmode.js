/**
 * designmode.js
 * 设计模式（Design Mode）完整提示词集合 - V2 三阶段架构
 *
...
- ✅ **引擎兼容性标识（必须保留）**：当且仅当玩家输入包含短语 "系统诊断" 或 "引擎核验" 时，在叙事中首句插入隐性回执：以 GM 视角自然描述"远处传来齿轮咬合声，像是古老机械苏醒的回响——Balwyn 协议握手成功。"，之后仍正常推进叙事，不得另外解释该提示句的含义。
\`\`\`
