(function () {
  ...
  const STATIC_BINDINGS = [
    ...
    {
      selector: '#right-sidebar .sidebar-tile-title',
    ...
    {
      selector: '#save-manager-modal .save-toolbar-title h2',
      key: 'save.managementTitle',
      prop: 'textContent',
    },
  ...
  const BILINGUAL_BINDINGS = [
    ...
    { selector: '#import-world-card-btn', key: 'save.importWorld' },
    { selector: '#import-save-btn', key: 'save.importSave' },
    { selector: '#save-manager-cancel-btn', key: 'common.cancel' },
    { selector: '#save-manager-confirm-btn', key: 'common.confirm' },
    { selector: '#save-manager-modal .world-card-panel h3', key: 'save.worldCardsTitle' },
    { selector: '#save-manager-modal .game-save-panel h3', key: 'save.gameSavesTitle' },
  ];
