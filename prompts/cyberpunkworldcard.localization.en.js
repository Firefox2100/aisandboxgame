(function () {
  ...
  "snapshot": {
    ...
    "prompt_modules": {
      ...
      "opening_greeting": "The buzz at the back of your neck fades as rain mixes with coolant down your spine.\nYou open your eyes to a memory that is empty — only a few error codes still flickering on your retina, telling you this body just rebooted. Neon reflections twist in puddles down the alley, a patrol drone's beam sweeps the far end now and then, but it has not turned on you yet. You have time, just not much.\n\nBefore you stand up, tell me:\n\n**1. Time** — what does the system log show?\n- New Era 45.06.05 01:10 (the night Zero cracked the Grace chip; the three factions are already fully entangled)\n- New Era 45.10.01 05:30 (the morning you woke up in a scrapyard)\n- New Era 44.01.10 09:30 (the day the Grace chip rollout began, with crowds still queuing for implants — full-arc route)\n- Or any specific moment you prefer.\n\n**2. Location** — what do your optics see?\n- Inside a scrap pile at the abandoned augment recycling yard\n- Deep in a disused Ghost Nodes server farm\n- A landfill along the folded-barrier edge\n- The back alley of the Quiet Terminus (a neutral refuge none of the three factions disturbs)\n- Or anywhere else you want.\n\nYou can also tell me who you are, why you woke, and what is hiding inside this body. If you would rather skip that, just choose \"Random Start\" or \"Start with the Recommended Opening\".",
