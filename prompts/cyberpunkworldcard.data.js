...
const BUILTIN_CYBERPUNK_WORLD_CARD_JSON = `{
  ...
  "snapshot": {
    ...
    "prompt_modules": {
      ...
      "opening_greeting": "电流声从后颈接口处淡去，雨水混着冷却液顺着脊柱滑落。\\n你睁开眼睛，记忆是空的——只有视网膜上还在闪烁的几行错误码，提示这具身体刚刚重启过。远处的霓虹倒影在积水中扭曲，巡逻无人机的探照灯偶尔扫过暗巷尽头，但暂时还没指向你。你有时间，但不多。\\n\\n在你站起来之前，先告诉我：\\n\\n**1. 时间** — 系统日志显示的是哪个时刻？\\n- 新元45.06.05 01:10（零号破解恩赐芯片的那一夜，三方博弈已成型）\\n- 新元45.10.01 05:30（你在回收站被当成废品唤醒的清晨）\\n- 新元44.01.10 09:30（恩赐芯片下沉计划刚启动，街上还在排队接种——完整体验）\\n- 也可以自定义一个具体时刻。\\n\\n**2. 地点** — 你的光学传感器拍到了什么？\\n- 废弃义体回收站的金属垃圾堆里\\n- 幽灵节点深处的废弃服务器农场\\n- 折叠屏障外围的垃圾填埋区\\n- 静音终点站的后巷（一处三方都默认不动的中立避难处）\\n- 或者其他你想去的地方。\\n\\n你也可以告诉我你是谁、为什么醒来、身体里藏着什么。如果不想多说，直接选「随机开始」或「以推荐剧情开始」。",
      "module_meta": {
