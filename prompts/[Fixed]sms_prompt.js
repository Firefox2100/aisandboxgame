...
function getContactInfo(contactId) {
  ...
  if (typeof npcStore !== 'undefined') {
    ...
    if (npcData) {
      const dynamicAge =
        typeof AnalyzerUtils !== 'undefined'
          ? AnalyzerUtils.calculateAgeFromBirthday(npcData.birthday, currentTime)
          : null;
      return {
        id: npcData.id || contactId,
        name: npcData.name || contactId,
        age: dynamicAge || '—',
        personality: npcData.personality || '未知',
        cognitive_state: npcData.cognitive_state || '未知',
        default_cognitive_state: npcData.cognitive_state || '未知',
        cognitive_state_timeline: [],
        appearance: npcData.appearance,
        clothing: npcData.clothing,
