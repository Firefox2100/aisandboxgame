...
class _DesignServiceP2Mixin {
        ...
        try {
          ...
          if (stage === 2) {
            ...
            if (!stageValidation.ok) {
              ...
              // 记录首次失败尝试到 debug payload
              designSteps.push({
                phase: 'phase2_stage2_attempt1',
              ...
              console.warn('[DesignService] Stage2 校验失败，启动反馈重试...', { fatalMessages });
  ...
  _isDesignWelcomeGreeting(msg) {
    ...
    // PHASE1_GREETING 欢迎横幅是 game.js 在进入设计模式时硬塞的工具操作说明，
